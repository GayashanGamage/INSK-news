    ...
    <div class="min-h-screen bg-[#1A1A2E] font-sans text-[#F7F7F7] p-4 sm:p-6 lg:p-10 antialiased">
        <div class="max-w-7xl mx-auto space-y-12">
            ...
            <section
                ...
                <img src="https://hotelprojects.blr1.cdn.digitaloceanspaces.com/INSK%20test/category%20images/basketball.webp"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-12">
                    ...
                    <section v-if="newsVisibility">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2" v-else-if="newsStore.basketballNews">
                            <div class="bg-[#2C394B] p-4 rounded-lg shadow-md transition duration-150 ease-in-out hover:shadow-lg border border-[#1A1A2E] hover:border-[#FF8A00] cursor-pointer"
                                v-for="(item, index) in newsStore.basketballNews" :key="item.uuid">
...
onBeforeMount(() => {
    ...
    if (newsStore.basketballNews == null) {
...
watch(pending, (newPending) => {
    ...
    if (newPending === false) {
        if (data.value) {
            ...
            newsStore.basketballNews = data.value;
...
useHead({
    title: newsStore.pageSeoData.basketball.title,
    meta: [
        {
            name: newsStore.pageSeoData.basketball.name,
            content: newsStore.pageSeoData.basketball.content,
        },
    ],
})
